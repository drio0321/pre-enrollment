...
preenrollment.addresstable ") or die (mysqli_error($conn)) ;
...
$sql = "SELECT * FROM preenrollment.addresstable  LIMIT $offset, $total_records_per_page";
...
<?php
    if(isset($_POST['searchsubmit'])){
        ...
        $sql = "SELECT * FROM addresstable WHERE idno LIKE '%$search%' OR lotNobuildingNo LIKE '%$search%'
        OR street LIKE '%$search%'OR brgy LIKE '%$search%'" ;
        ...
        if ($query_Result > 0){
            while ($row = mysqli_fetch_assoc($results)){
                ...
                <td><?php echo $row ['lotNobuildingNo']; ?></td>  
                <td><?php echo $row ['street']; ?></td>  
                <td><?php echo $row ['brgy']; ?></td>  
                <td><?php echo $row ['city']; ?></td>  
                <td><?php echo $row ['province']; ?></td>  
                <td> 
                <a href="../php/updateadd.php?address_id=<?php echo $row['address_id'] ?>" class= "link-sky" ><i class="uil uil-edit"></i></a>
                <a href="../php/deleteadd.php?address_id=<?php echo $row['address_id'] ?> " class= "link-red" ><i class="uil uil-trash" ></i></a> 
                </td>   
            </tr>
                <?php 
                } 
