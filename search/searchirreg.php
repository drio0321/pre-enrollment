...
preenrollment.tbleirreg") or die (mysqli_error($conn)) ;
...
$sql = "SELECT * FROM preenrollment.tbleirreg  LIMIT $offset, $total_records_per_page";
...
<?php
    if(isset($_POST['searchsubmit'])){
        ...
        $sql = "SELECT * FROM tbleirreg WHERE idno LIKE '%$search%' OR subCode LIKE '%$search%'
        OR subDes LIKE '%$search%'OR section LIKE '%$search%'" ;
        ...
        if ($query_Result > 0){
            while ($row = mysqli_fetch_assoc($results)){
                ...
                <td> 
                <a href="../php/updateirreg.php?irreg_id=<?php echo $row['irreg_id'] ?>" class= "link-sky" ><i class="uil uil-edit"></i></a>
                <a href="../php/deleteirreg.php?irreg_id=<?php echo $row['irreg_id'] ?> " class= "link-red" ><i class="uil uil-trash" ></i></a> 
                </td>   
            </tr>
                <?php 
                } 
