...
preenrollment.subjecttable") or die (mysqli_error($conn)) ;
...
$sql = "SELECT * FROM preenrollment.subjecttable  LIMIT $offset, $total_records_per_page";
...
<?php
    if(isset($_POST['searchsubmit'])){
        ...
        $sql = "SELECT * FROM subjecttable WHERE subCode LIKE '%$search%' OR subDes LIKE '%$search%'
        OR section LIKE '%$search%'OR units LIKE '%$search%'" ;
        ...
        if ($query_Result > 0){
            while ($row = mysqli_fetch_assoc($results)){
                ?>
                <tr>
                <td scope = "row"><?php echo $row ['subCode']; ?></td>  
                ...
                <td> 
                <a href="../php/update.php?subject_id=<?php echo $row['subject_id'] ?>" class= "link-sky" ><i class="uil uil-edit"></i></a>
                <a href="../php/delete.php?subject_id=<?php echo $row['subject_id'] ?> " class= "link-red" ><i class="uil uil-trash" ></i></a> 
                </td>   
            </tr>
                <?php 
                } 
