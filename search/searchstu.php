...
<?php
    if(isset($_POST['searchsubmit'])){
        ...
        $sql = "SELECT * FROM studenttable WHERE idno LIKE '%$search%' OR fname LIKE '%$search%'
        ...
        if ($query_Result > 0){
            while ($row = mysqli_fetch_assoc($results)){
                ...
                <a href="../php/deletestu.php?student_=<?php echo $row['student_id'] ?> " class= "link-red" ><i class="uil uil-trash" ></i></a> 
                </td>   
            </tr>
                <?php 
                } 
