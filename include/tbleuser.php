...
if (isset($_GET['page_no']) && $_GET ['page_no'] !==""){
    ...
    preenrollment.userinfo") or die (mysqli_error($conn)) ;
    ...
    $sql = "SELECT * FROM preenrollment.userinfo LIMIT $offset, $total_records_per_page";
    ...
    <section class="dashboard">
        <div class="top">
            ...
            <div class="search-box">
                ...
                <form action="../search/searchuser.php" method="POST">
        ...
        <div class="dash-content">
            <div class="overview">
                <div class="title">
                    ...
                    <form action="..search/searchsuser.php" method="POST">
                    <span class="text">User</span>
                    <button class="new" type = "text" ><a href ="user.php">New</a></button>
                </div>
                <table class ="table" >
        <thead>
            <tr>
        ...
        <?php
                ...
                while ($row = mysqli_fetch_assoc($results)) {
                        ...
                        <td> 
                        <a href="../php/updateuser.php?user_id=<?php echo $row['user_id'] ?>" class= "link-sky" ><i class="uil uil-edit"></i></a>
                        <a href="../php/deleteuser.php?user_id=<?php echo $row['user_id'] ?> " class= "link-red" ><i class="uil uil-trash" ></i></a> 
                        </td>   
                    </tr>
