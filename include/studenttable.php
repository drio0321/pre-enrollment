...
if (isset($_GET['page_no']) && $_GET ['page_no'] !==""){
    ...
    preenrollment.studenttable") or die (mysqli_error($conn)) ;
    ...
    $sql = "SELECT * FROM preenrollment.studenttable LIMIT $offset, $total_records_per_page";
    ...
    <section class="dashboard">
        <div class="top">
            ...
            <div class="search-box">
                ...
                <form action="../search/searchstu.php" method="POST">
        ...
        <div class="dash-content">
            <div class="overview">
                <div class="title">
                    ...
                    <button class="new" type = "text" ><a href ="student.php">New</a></button>
                </div>
                <table class ="table" >
        <thead>
            <tr>
        ...
        <?php
                ...
                while ($row = mysqli_fetch_assoc($results)) {
                        ...
                        <td> 
                        <a href="../php/updatestu.php?student_id=<?php echo $row['student_id'] ?>" class= "link-sky" ><i class="uil uil-edit"></i></a>
                        <a href="../php/deletestu.php?student_id=<?php echo $row['student_id'] ?> " class= "link-red" ><i class="uil uil-trash" ></i></a> 
                        </td>   
                    </tr>
